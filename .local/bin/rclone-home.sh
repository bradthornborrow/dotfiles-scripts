...
rclone sync $2 --exclude '*cache*/' --exclude '*Cache*/' --exclude '.DS_Store' --exclude '.Trash/' --exclude 'Library/CloudStorage/ShellFish' --modify-window=2s --multi-thread-streams=4 -P -L --metadata $HOME/ $1$HOME
echo ""
